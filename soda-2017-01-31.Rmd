...
- New sources of (non-lab-based) data from wearables, social media, electronic education/medical records
- Vertically siloed
- Widespread access for research threatens 
    - individual privacy
...
- Science denialism largely sociocultural
    + Credibility of 'statistics' in question

---

- Problems humans face in 21st c. require scientific solutions
    + technical
    + social/political/economic
    + behavioral
- Fraud/reproducibility problems undermine public trust
...
<img src="https://raw.githubusercontent.com/psu-psychology/psy-511-scan-fdns/master/lectures/img/autism-and-beyond.jpg" width=800px>
</a>
</div>
...
<div class="centered">
<img src="https://raw.githubusercontent.com/gilmore-lab/psu-child-study-ctr-talk-2016-10-28/master/img/meesearch-logo.jpg" width=900px>
</div>
...
- Astro, geo, bio-sciences have common frames of reference, liking variables
...
- Ask participants permission to share with researchers for research purposes
...
This talk was produced in [RStudio](http://rstudio.com) version 1.044 on `r Sys.Date()`. The code used to generate the slides can be found at <http://github.com/gilmore-lab/soda-2017-01-31/>. Information about the R Session that produced the code is as follows:
